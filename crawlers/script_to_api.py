...
api_save_url = os.getenv('URL_API_CRAWLER_SAVE', '')
...
def callback(ch, method, properties, body):
    try:
        ...
        if attempts == max_attempts:
            print(f"O envio de mensagem falhou {max_attempts} vezes. Movendo para {crawler_to_api_dlq}.")
...
channel.basic_consume(crawler_to_api_queue, callback)
